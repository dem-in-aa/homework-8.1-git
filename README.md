# Домашнее задание к занятию «8.1. Git» Андрей Дёмин
...
![alt Скриншот 1](https://github.com/dem-in-aa/homework-8.1-git/main/img/screen_1.png)
2. Создайте публичный репозиторий. Обязательно поставьте галочку в поле «Initialize this repository with a README».
![alt Скриншот 2](https://github.com/dem-in-aa/homework-8.1-git/main/img/screen_2.png)
3. Склонируйте репозиторий, используя https протокол `git clone ...`.
![alt Скриншот 3](https://github.com/dem-in-aa/homework-8.1-git/main/img/screen_3.png)
4. Перейдите в каталог с клоном репозитория.
5. Произведите первоначальную настройку Git, указав своё настоящее имя и email: `git config --global user.name` и `git config --global user.email johndoe@example.com`.
![alt Скриншот 4](https://github.com/dem-in-aa/homework-8.1-git/main/img/screen_4.png)
6. Выполните команду `git status` и запомните результат.
7. Отредактируйте файл README.md любым удобным способом, переведя файл в состояние Modified.
![alt Скриншот 5](https://github.com/dem-in-aa/homework-8.1-git/main/img/screen_5.png)
